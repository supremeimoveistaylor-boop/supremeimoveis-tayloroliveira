...
import { Search, Bed, Bath, Car, Maximize, MapPin, X, Filter, Home } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
            ...
            <div className="bg-white rounded-lg shadow-md p-4 mb-6">
              ...
              {hasActiveFilters && (
                <div className="mt-4 flex flex-wrap gap-2 items-center">
                  ...
                  {(minPrice || maxPrice) && (
                    <Badge variant="secondary" className="flex items-center gap-1">
                      Aluguel: {minPrice ? formatPrice(parseInt(minPrice)) : "0"} - {maxPrice ? formatPrice(parseInt(maxPrice)) : "∞"}
      ...
      <RealEstateChat 
        ...
        pageContext={propertyType ? `imóveis para alugar (${propertyType})` : "imóveis para alugar"}
        origin="site"
      />
    </div>
  );
