...
export const RealEstateChat = ({ propertyId, propertyName, origin }: RealEstateChatProps) => {
  ...
  if (isMinimized) {
    return (
      <div 
        className="fixed bottom-6 right-6 bg-primary text-primary-foreground rounded-full px-4 py-3 shadow-lg cursor-pointer z-50 flex items-center gap-2"
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[380px] max-w-[calc(100vw-48px)] h-[500px] max-h-[calc(100vh-100px)] bg-background rounded-2xl shadow-2xl flex flex-col z-50 border">
      {/* Header */}
