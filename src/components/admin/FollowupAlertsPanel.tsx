        ...
        <Card className="bg-white border-slate-200">
          <CardContent className="pt-4 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xl font-bold text-slate-800">{brokerReminders.length}</p>
                <p className="text-xs text-slate-500">Cobranças Corretor</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="bg-white border-slate-200">
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between flex-wrap gap-2">
            ...
            <Button variant="outline" size="sm" onClick={fetchAlerts} disabled={isLoading} className="border-slate-200 text-slate-600 hover:bg-slate-100">
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow className="border-slate-200">
                          ...
                          <TableHead className="text-slate-600">Imóvel</TableHead>
                          <TableHead className="text-slate-600">Lead</TableHead>
                      ...
                      <TableBody>
                        {campaigns.map((camp) => (
                          <TableRow key={camp.id} className="border-slate-200">
                            ...
                            <TableCell className="text-slate-600 text-sm truncate max-w-[150px]">
                  ...
                  <ScrollArea className="max-h-[600px]">
                    <Table>
                      <TableHeader>
                        <TableRow className="border-slate-200">
                          <TableHead className="text-slate-600">Tipo</TableHead>
                          <TableHead className="text-slate-600">Estágio</TableHead>
                          <TableHead className="text-slate-600">Destinatário</TableHead>
                          <TableHead className="text-slate-600">Status</TableHead>
                          <TableHead className="text-slate-600">Mensagem</TableHead>
                          <TableHead className="text-slate-600">Data</TableHead>
                        </TableRow>
                      </TableHeader>
                      <TableBody>
