      ...
      <Tabs value={activeSubTab} onValueChange={setActiveSubTab}>
          ...
          <Card className="bg-white border-slate-200">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-slate-800">⚙️ Configurações Globais de SEO</CardTitle>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm text-slate-600">Nome da Imobiliária</label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-sm text-slate-600">Cidade Principal</label>
                  <Input
              ...
              <div className="space-y-2">
                <label className="text-sm text-slate-600">URL Canônica Base</label>
                <Input
              ...
              <div className="space-y-2">
                <label className="text-sm text-slate-600">Palavras-chave Principais (separadas por vírgula)</label>
                <Input
              ...
              <Card className="bg-slate-50 border-slate-200">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm text-slate-500">🔍 Preview Google</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-1">
                    ...
                    <p className="text-slate-500 text-sm line-clamp-2">{globalConfig.defaultDescription}</p>
                  </div>
                </CardContent>
              </Card>
            </CardContent>
        ...
        <TabsContent value="pages" className="space-y-4">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button variant="outline" size="sm" onClick={addNewPage} className="border-slate-200 text-slate-600 hover:bg-slate-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 space-y-4">
              <Card className="bg-white border-slate-200">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-slate-800">📝 SEO da Página</CardTitle>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm text-slate-600">Palavra-chave Foco</label>
                      <Input
                  ...
                  <div className="space-y-2">
                    <label className="text-sm text-slate-600">H1 Principal</label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <label className="text-sm text-slate-600">H2 Secundários (um por linha)</label>
                    <Textarea
                  ...
                  <div className="space-y-2">
                    <label className="text-sm text-slate-600">Texto Otimizado (corpo da página)</label>
                    <Textarea
              ...
              <Card className="bg-white border-slate-200">
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button variant="outline" size="sm" onClick={addFaq} className="border-slate-200 text-slate-600 hover:bg-slate-100">
            ...
            <div className="space-y-4">
              <Card className="bg-white border-slate-200">
                <CardHeader>
                  <CardTitle className="text-slate-800">📊 Score SEO</CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <TabsContent value="local" className="space-y-4">
          <Card className="bg-white border-slate-200">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-slate-800">📍 SEO Local Avançado</CardTitle>
                  <CardDescription className="text-slate-500">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <label className="text-sm text-slate-600">Região</label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-sm text-slate-600">Tipo de Imóvel</label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-sm text-slate-600">Faixa de Valor</label>
                  <Input
              ...
              {/* Suggested keywords */}
              <div className="space-y-2">
                <label className="text-sm text-slate-600">🔑 Keywords Sugeridas (SEO Local)</label>
        ...
        <TabsContent value="preview" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card className="bg-white border-slate-200">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => copyToClipboard(schemaLocalBusiness, "Schema LocalBusiness")} className="border-slate-200 text-slate-600">
            ...
            <Card className="bg-white border-slate-200">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => copyToClipboard(schemaFAQ, "Schema FAQ")} className="border-slate-200 text-slate-600">
                    <Copy className="w-4 h-4 mr-1" /> Copiar
                  </Button>
                </div>
              </CardHeader>
            ...
            <Card className="bg-white border-slate-200">
              <CardHeader>
                <CardTitle className="text-slate-800">🌐 Open Graph Preview</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="bg-slate-900/80 rounded-lg border border-slate-200 overflow-hidden">
